                            ...
                            for (Object nav : var_collectionvar0_list_coerced$) {
                                {
                                    ...
                                    if (var_traversal9) {
                                        out.write("\n                    <li");
                                        {
                                            String var_attrcontent10 = ((("nav-item " + renderContext.getObjectModel().toString(renderContext.call("xss", (renderContext.getObjectModel().toBoolean(renderContext.getObjectModel().resolveProperty(nav, "current")) ? "active" : ""), "attribute"))) + "  ") + renderContext.getObjectModel().toString(renderContext.call("xss", ((!(org.apache.sling.scripting.sightly.compiler.expression.nodes.BinaryOperator.leq(renderContext.getObjectModel().resolveProperty(renderContext.getObjectModel().resolveProperty(nav, "children"), "size"), 0))) ? "dropdown" : ""), "attribute")));
                                            out.write(" class=\"");
                                        ...
                                        out.write(">\n                        ");
                                        {
                                            boolean var_testvariable11 = (org.apache.sling.scripting.sightly.compiler.expression.nodes.BinaryOperator.strictEq(renderContext.getObjectModel().resolveProperty(renderContext.getObjectModel().resolveProperty(nav, "children"), "size"), 0));
                                        ...
                                        out.write("\n\t\t\t\t\t\t\n\t\t\t\t\t\t");
                                        {
                                            boolean var_testvariable14 = (!(org.apache.sling.scripting.sightly.compiler.expression.nodes.BinaryOperator.leq(renderContext.getObjectModel().resolveProperty(renderContext.getObjectModel().resolveProperty(nav, "children"), "size"), 0)));
                                            if (var_testvariable14) {
                                                out.write("<a class=\"nav-link dropdown-toggle\"");
                                                {
                                                    String var_attrcontent15 = (renderContext.getObjectModel().toString(renderContext.call("xss", renderContext.getObjectModel().resolveProperty(renderContext.getObjectModel().resolveProperty(nav, "page"), "path"), "uri")) + ".html");
                                                    out.write(" href=\"");
                                                    out.write(renderContext.getObjectModel().toString(var_attrcontent15));
                                                    out.write("\"");
                                                }
                                                {
                                                    String var_attrcontent16 = ("dropdownMenuButton" + renderContext.getObjectModel().toString(renderContext.call("xss", null, "attribute")));
                                                    out.write(" id=\"");
